...
Public Class GraphicPerItem
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TDHPointOfSale.GraphicPerItem.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGraphicPerItem
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GraphicPerItem = New GraphicPerItem()
        rpt.Site = Me.Site
        Return rpt
    End Function
