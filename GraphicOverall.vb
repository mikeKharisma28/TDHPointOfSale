...
Public Class GraphicOverall
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TDHPointOfSale.GraphicOverall.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGraphicOverall
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GraphicOverall = New GraphicOverall()
        rpt.Site = Me.Site
        Return rpt
    End Function
