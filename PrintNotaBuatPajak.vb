...
Public Class PrintNotaBuatPajak
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TDHPointOfSale.PrintNotaBuatPajak.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPrintNotaBuatPajak
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PrintNotaBuatPajak = New PrintNotaBuatPajak()
        rpt.Site = Me.Site
        Return rpt
    End Function
